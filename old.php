...
error_reporting(0);
        ...
        $idml = "5431013";  // preencha com seu id de Mecado Sócio
     $urlloja = "http://loja.3gamers.com.br/";  // prencha com a url completa (sem esquecer do http://) da loja e terminando com uma /
$urlprincipal = "http://www.3gamers.com.br/";  // preencha com a url da home de seu blog ou site (sem esquecer do http://e terminando com uma / )
...
$endereco = "http://secundum.com.br/parceiros/superloja.php?id_ml=".$idml."&busca=".$busca."&url=".urlencode($urlloja)."&site=".urlencode($urlprincipal)."&filtro=".$filtro;
